...
<header class="bg-gray-300 w-full h-20 flex items-center justify-between px-6 lg:px-10 shadow-md fixed top-0 z-10">
    ...
    <nav id="desktop-menu" class="hidden lg:flex items-center space-x-6">
        <a href="#home"
           class="text-lg font-medium text-black hover:text-blue-100 hover:border-2 hover:bg-blue-500 hover:border-blue-100 transition duration-300">Home</a>
        <a href="#about"
           class="text-lg font-medium text-black hover:text-blue-100 hover:border-2 hover:bg-blue-500 hover:border-blue-100 transition duration-300">About</a>
        <a href="#contact"
           class="text-lg font-medium text-black hover:text-blue-100 hover:border-2 hover:bg-blue-500 hover:border-blue-100 transition duration-300">Contact</a>
    </nav>

    <!-- Desktop Login and Sign In Buttons -->
    <div class="hidden lg:flex items-center space-x-4">
        <a href="{{ route('login') }}">
            <button class="w-full bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 mb-2">login</button>
        </a>
...
<section id="home_data"
         class="flex flex-col lg:flex-row items-center justify-center py-20 bg-white pt-24 gap-10 lg:gap-20">
    ...
    <div class="max-w-6xl mx-auto text-center">
        ...
        <div class="max-w-6xl mx-auto flex items-center justify-center space-x-8">
            ...
            <p class="text-lg text-gray-700 leading-relaxed max-w-4xl text-left">
                TobaPOS berdiri dengan semangat menghadirkan tembakau berkualitas yang memadukan tradisi dan inovasi.
                Sejak awal berdiri,kami telah bekerja bersama petani lokal terbaik, memastikan setiap helai tembakau
                diproses dengan dedikasi tinggi untuk menghasilkan produk unggulan. Berawal dari usaha kecil, kami kini
                tumbuh menjadi salah satu pemain utama di industri dengan berbagai pencapaian yang diakui. Komitmen kami
                tak hanya pada kualitas, tetapi juga pada keberlanjutan dan kesejahteraan komunitas.
                Mari menjadi bagian dari perjalanan kami untuk terus menciptakan produk yang mencerminkan rasa dan
                keunggulan sejati.
            </p>
        </div>
</section>
...
<section id="contact" class="contact py-20 bg-gray-300">
    <div class="max-w-6xl mx-auto text-center">
        ...
        <p class="text-lg text-gray-700 mb-4">Jl. Pintu Ledeng, Ciomas, Kec. Ciomas, Kabupaten Bogor, Jawa Barat
            16610</p>
